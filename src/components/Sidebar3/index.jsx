...
export default function Sidebar3({ ...props }) {
  return (
    <Sidebar {...props} width="249px !important">
      <Img src="images/img_group_18298.svg" alt="image" className="h-[30px] mt-6 ml-[27px] mr-[97px] md:mr-5 sm:mx-5" />
      <Menu
        menuItemStyles={{
          button: {
            padding: " ",
      ...
      >
        <div className="flex flex-row justify-start items-center w-full gap-2 p-2.5">
          <Img src="images/img_circlesfour_blue_gray_400.svg" alt="image_one" className="h-[20px] w-[20px] ml-[19px]" />
        ...
        <SubMenu>
          <div className="flex flex-row justify-between items-center w-full p-[7px]">
            <div className="flex flex-row justify-start items-center ml-[22px] gap-2 sm:ml-5">
        ...
        <SubMenu>
          <div className="flex flex-row justify-between items-start w-full pt-2.5 px-2.5">
            ...
            <Img
              ...
              alt="arrowright"
              className="h-[24px] w-[24px] mt-2.5 cursor-pointer"
            />
          </div>
        </SubMenu>
        <SubMenu>
          <div className="flex flex-row justify-between items-start w-full pt-2.5 px-2.5">
            ...
            <Img
              src="images/img_arrow_right.svg"
              alt="arrowright_five"
              className="h-[24px] w-[24px] mt-[22px] cursor-pointer"
            />
          </div>
        </SubMenu>
        <div className="flex flex-row justify-start items-center w-full mt-[49px] gap-2 p-2.5">
          <Img src="images/img_frame_20.svg" alt="vector_three" className="h-[16px] w-[16px] ml-[18px]" />
          <Text size="lg" as="p" className="!text-blue_gray-400">
            Analytics
          </Text>
        </div>
        <SubMenu>
          <div className="flex flex-row justify-between items-center w-full p-2">
            <div className="flex flex-row justify-start items-center ml-[21px] gap-2 sm:ml-5">
              <Img src="images/defaultNoData.png" alt="image_three" className="h-[16px] w-[16px]" />
              <Text size="lg" as="p" className="!text-blue-A200">
                Table{" "}
              </Text>
            </div>
            <div className="h-[24px] w-[24px] mr-[29px] sm:mr-5 rotate-[90deg]" />
          </div>
          <div className="flex flex-col items-center justify-start w-full">
            <div className="flex flex-row justify-start w-full p-2.5">
              <Text size="lg" as="p" className="ml-[42px] md:ml-5 !text-blue_gray-400">
                Add Table
              </Text>
            </div>
            <div className="flex flex-row justify-start w-full p-2.5">
              <Text size="lg" as="p" className="ml-[42px] md:ml-5 !text-blue-A200">
                Table List
              </Text>
            </div>
            <div className="flex flex-row justify-start w-full p-2.5">
      ...
      <div className="flex flex-col items-start justify-start w-full mt-[140px] mb-[92px] mx-auto md:px-5 max-w-[189px]">
        <Img src="images/defaultNoData.png" alt="image_four" className="w-full md:h-auto sm:w-full object-cover" />

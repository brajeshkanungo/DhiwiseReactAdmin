...
export default function Sidebar4({ ...props }) {
  return (
    <Sidebar {...props} width="250px !important">
      ...
      <Menu
        ...
        renderExpandIcon={() => (
          <Img
            ...
            alt="arrowright_one"
            className="h-[24px] w-[24px] mt-5 cursor-pointer"
          />
        )}
      ...
      >
        ...
        <SubMenu>
          <div className="flex flex-row justify-between items-start w-full p-[7px]">
            <div className="flex flex-row justify-start items-center mt-[3px] ml-[23px] gap-2 sm:ml-5">
              <Img src="images/img_group_18278.svg" alt="rocketlaunch" className="h-[16px] w-[16px]" />
              <Text size="lg" as="p" className="!text-blue-A200">
                Orders
              </Text>
            </div>
            <div className="h-[24px] w-[24px] mr-[27px] sm:mr-5 rotate-[90deg]" />
          </div>
      ...
      <div className="flex flex-col items-start justify-start w-full mt-[186px] mb-[84px] mx-auto md:px-5 max-w-[189px]">

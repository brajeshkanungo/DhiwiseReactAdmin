  ...
  return (
    <div style={{ height: "100vh", padding: "20px", backgroundColor: "#232323", color: "white" }}>
      ...
      <ul style={{ listStyle: "none", padding: "0" }}>
        ...
        <li style={{ marginBottom: "10px" }}>
          <Link to="/review" style={{ color: "#87CEFA", textDecoration: "none" }}>
            Review
          </Link>
        </li>
        <li style={{ marginBottom: "10px" }}>
          <Link to="/addmenu" style={{ color: "#87CEFA", textDecoration: "none" }}>
            AddMenu
          </Link>
        </li>
        <li style={{ marginBottom: "10px" }}>
          <Link to="/menulist" style={{ color: "#87CEFA", textDecoration: "none" }}>
            MenuList
          </Link>
        </li>
      </ul>
